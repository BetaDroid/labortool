...
var DistributorCallServices = (function () {
    function DistributorCallServices(http, host) {
        var _this = this;
        this.http = http;
        this.host = host;
    ...
    DistributorCallServices.prototype.handleError = function (error) {
        console.error(error);
        return Rx_1.Observable.throw(error.json().error || 'Server error');
    };
    DistributorCallServices = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, connection_service_1.ConnectionService])
    ], DistributorCallServices);
    return DistributorCallServices;
}());
exports.DistributorCallServices = DistributorCallServices;
