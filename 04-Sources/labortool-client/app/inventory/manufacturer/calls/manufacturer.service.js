...
var ManufacturerCallServices = (function () {
    function ManufacturerCallServices(http, host) {
        var _this = this;
        this.http = http;
        this.host = host;
    ...
    ManufacturerCallServices.prototype.handleError = function (error) {
        console.error(error);
        return Rx_1.Observable.throw(error.json().error || 'Server error');
    };
    ManufacturerCallServices = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, connection_service_1.ConnectionService])
    ], ManufacturerCallServices);
    return ManufacturerCallServices;
}());
exports.ManufacturerCallServices = ManufacturerCallServices;
